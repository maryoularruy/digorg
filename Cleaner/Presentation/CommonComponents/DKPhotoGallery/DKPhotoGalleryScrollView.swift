...
class MediaCarouselScrollView: UIScrollView {
    
    private var views = Array<UIView?>()
    private var items = [MediaCarouselItem : UIView]()
    ...
    public func set(vc: UIViewController, item: MediaCarouselItem, atIndex index: Int) {
    ...
    public func remove(vc: UIViewController, item: MediaCarouselItem) {
