...
@objc
public protocol MediaCarouselDelegate : NSObjectProtocol {
    
    /// Called by the gallery just after it shows the index.
    @objc optional func photoGallery(_ gallery: MediaCarousel, didShow index: Int)
    
}

@objc
public protocol MediaCarouselIncrementalDataSource : NSObjectProtocol {
    
    @objc optional func numberOfItems(in gallery: MediaCarousel) -> Int
    
    // Return 'nil' to indicate that no more items can be made in the given direction.
    @objc func photoGallery(_ gallery: MediaCarousel,
                            itemsBefore item: MediaCarouselItem?,
                            resultHandler: @escaping ((_ items: [MediaCarouselItem]?, _ error: Error?) -> Void))
    
    @objc func photoGallery(_ gallery: MediaCarousel,
                            itemsAfter item: MediaCarouselItem?,
                            resultHandler: @escaping ((_ items: [MediaCarouselItem]?, _ error: Error?) -> Void))
    
}

@objc
public enum MediaCarouselSingleTapMode : Int {
    case
    dismiss, // Dismiss MediaCarousel when user tap on the screen.
    toggleControlView
}

@objc
open class MediaCarousel: UINavigationController, UIViewControllerTransitioningDelegate,
MediaCarouselContentDataSource, MediaCarouselContentDelegate {
	
    @objc open var items: [MediaCarouselItem]?
    @objc open var incrementalDataSource: MediaCarouselIncrementalDataSource?
    
    @objc open var finishedBlock: ((_ index: Int, _ item: MediaCarouselItem) -> UIImageView?)?
    ...
    @objc open var singleTapMode = MediaCarouselSingleTapMode.toggleControlView
    
    @objc weak open var galleryDelegate: MediaCarouselDelegate?
    ...
    open var transitionController: MediaCarouselTransitionController?
    
    internal var statusBar: UIView?
    internal weak var contentVC: MediaCarouselContentVC?
    ...
    open override func viewDidLoad() {
        ...
        let contentVC = MediaCarouselContentVC()
        ...
        contentVC.navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.cancel,
                                                                     target: self,
                                                                     action: #selector(MediaCarousel.dismissGallery))
    ...
    // MARK: - MediaCarouselContentDataSource
    ...
    internal func item(for index: Int) -> MediaCarouselItem {
    ...
    // MARK: - MediaCarouselContentDelegate
    
    internal func contentVCCanScrollToPreviousOrNext(_ contentVC: MediaCarouselContentVC) -> Bool {
    ...
    open override var preferredStatusBarStyle: UIStatusBarStyle {
        return MediaCarousel._preferredStatusBarStyle
    }
}

public extension UIViewController {
    
    @objc func present(photoGallery gallery: MediaCarousel, completion: (() -> Swift.Void)? = nil) {
        gallery.modalPresentationStyle = .custom
        
        gallery.transitionController = MediaCarouselTransitionController(gallery: gallery,
