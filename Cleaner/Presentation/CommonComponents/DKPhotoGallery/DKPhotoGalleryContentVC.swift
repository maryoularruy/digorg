...
fileprivate class MediaCarouselContentFooterViewContainer : UIView {
...
internal protocol MediaCarouselContentDataSource: AnyObject {
    
    func item(for index: Int) -> MediaCarouselItem
...
internal protocol MediaCarouselContentDelegate: AnyObject {
    
    func contentVCCanScrollToPreviousOrNext(_ contentVC: MediaCarouselContentVC) -> Bool
    
}

@objc
open class MediaCarouselContentVC: UIViewController, UIScrollViewDelegate {
    
    internal weak var dataSource: MediaCarouselContentDataSource!
    ...
    private func updateFooterView() {
        ...
        if let footerView = self.footerView {
            self.footerViewContainer = MediaCarouselContentFooterViewContainer(footerView: footerView)
    ...
    private func updateVisibleViews(index: Int, scrollToIndex need: Bool, animated: Bool = false, indexOnly: Bool = false) {
        ...
        if indexOnly {
            ...
            var visibleItems = [MediaCarouselItem : Int]()
    ...
    private func addToReuseQueueFromVisibleQueueIfNeeded(item: MediaCarouselItem) {
        if let vc = self.visibleVCs[item] {
