...
open class DKPlayerView: UIView {
    ...
    private func setupUI() {
        ...
        self.playButton.setImage(MediaCarouselResource.videoPlayImage(), for: .normal)
        ...
        self.closeButton.setImage(MediaCarouselResource.closeVideoImage(), for: .normal)
        ...
        self.playPauseButton.setImage(MediaCarouselResource.videoToolbarPlayImage(), for: .normal)
        self.playPauseButton.setImage(MediaCarouselResource.videoToolbarPauseImage(), for: .selected)
        ...
        self.timeSlider.setThumbImage(MediaCarouselResource.videoTimeSliderImage(), for: .normal)
        ...
        let backgroundImageView = UIImageView(image: MediaCarouselResource.videoPlayControlBackgroundImage())
        ...
        if keyPath == #keyPath(AVPlayerItem.duration) {
            ...
            if newStatus == .readyToPlay {
                ...
                if let error = currentItem.error {
                    ...
                    self.showPlayError(MediaCarouselResource.localizedStringWithKey("preview.player.error.unknown"))
                }
