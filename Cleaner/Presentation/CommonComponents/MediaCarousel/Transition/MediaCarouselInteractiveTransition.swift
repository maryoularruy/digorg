//
//  MediaCarouselInteractiveTransition.swift
//  MediaCarousel
//
...
class MediaCarouselInteractiveTransition: UIPercentDrivenInteractiveTransition, UIGestureRecognizerDelegate {

    private var gallery: MediaCarousel!
    ...
    convenience init(gallery: MediaCarousel) {
        self.init()
